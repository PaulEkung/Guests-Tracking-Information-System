...
<span class="fs-1">Total Staffs</span>
<span class="bi bi-plus-circle-fill fs-2 offset-6">
<a href="add-staffs.php" class="fs-4 text-decoration-none">Add Staffs</a>
</span>
...
<br>
        ...
        <th class="p-3">Type of Employment</th>
...
<br>
<!-- <form action="" class="fixed-bottom mb-3 position-absolute">
<div class="container">
<div class="row">
<div class="col-sm-8 offset-0 m-0">
<input type="search" class="form-control w-50" placeholder="Search Staff">

</div>
<div class="col-sm-3">
<button type="submit" class="offset-0 btn btn" style="margin-left:-28.7rem; margin-top:-1.2rem"><i class="bi bi-arrow-right-circle-fill fs-1"></i></button>
